...
<body>
	...
	String uploadPath = "/home/hosting_users/qd6789/tomcat/webapps/ROOT/img"; //개인마다 WebContent 아래에 img 폴더 경로로 지정해야 함
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<button type="button" onclick="location.href='/main.jsp'" class="btn-close" data-bs-dismiss="modal"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<button type="button" onclick="location.href='foodAdd.jsp'" class="btn-close" data-bs-dismiss="modal"
						aria-label="Close"></button>
				</div>
				<div class="modal-body">
					푸드 트럭 등록에 실패했습니다. <br>
